...
## 3. 3. EXPLICACIÓN Y RESOLUCIÓN DE LOS EJERCICIOS

2. Para los transformadores de la figura 23-71, dibuje las formas de onda que faltan.
...
4. Un transformador ideal tiene Np = 1000 vueltas y Ns = 4000 vueltas.
...
6. Para la figura 23-72, determine las expresiones para v1, v2 y v3.
...
8. Si, para la figura 23-73, Eg = 240 V∠0°, a = 0.5, e Ig = 2 A∠20°, determine lo siguiente:
a. IL b. VL c. ZL
...
10. Si, para la figura 23-73, a = 4, Ig = 4 A∠30°, y ZL = 6 Ω - j8 Ω, determine lo siguiente:
a. VL b. Eg
...
12. Para cada circuito de la figura 23-74, determine Zp.
...
14. Para la figura 23-74(a), ¿qué relación de vueltas se requiere para hacer que Zp = (62.5 - j125) Ω?
...
16. Para cada circuito de la figura 23-75, determine ZT.
...
18. Un transformador tiene una especificación de voltaje primario de 7.2 kV, a = 0.2, y una especificación de corriente en el secundario de 3 A. ¿Cuál es la especificación de kVA?

![image](https://user-images.githubusercontent.com/84425276/132609079-e77c53ae-211c-4272-a789-5cbfac43a762.png)


20. El transformador de la figura 23-25 tiene un primario de 7200 V y un secundario de 240 V con terminal central. Si la carga 1 consiste en doce lámparas de 100 W, la carga 2 es un calentador de 1500 W y la carga 3 es una horno de
...
22. Un amplificador con un equivalente de Thévenin de 10 V y RTh de 25 Ω manejan una bocina de 4 Ω a través de un transformador con una relación de vueltas de a = 5. ¿Cuánta potencia es suministrada a la bocina? ¿Qué relación de vueltas produce 1 W?
...
24. Para la figura 23-30(a), a2 = 2 y a3 = 5, Z2 = 20 Ω∠50°, Z3 = (12 + j4)  Ω y Eg = 120 V∠0°. Encuentre cada corriente de carga y la corriente del generador.
...
26. Para la figura 23-77, Eg = 1220 V∠∠0°.
...
28. Un transformador que entrega Psal = 48 kW tiene un perdida en el núcleo de 280 W y una perdida en el cobre de 450 W. ¿Cuál es su eficiencia a esta carga?

![image](https://user-images.githubusercontent.com/84425276/132607407-53b2e896-e883-4711-97a1-ac4d500406e1.png)

30. Para la figura 23-78,
...
32. Para un conjunto de bobinas acopladas, L1 = 2 H, M = 0.8 H y el coeficiente de acoplamiento es de 0.6. Determine L2.

![image](https://user-images.githubusercontent.com/84425276/132607679-6e698719-d7b5-45f5-a0bc-41dcc4074823.png)

34. Todo igual que en el problema 32, excepto que i1 = 10 e^-500t A. Encuentre las ecuaciones de los voltajes del primario y el secundario. Calcule los a t = 1 ms.
...
38. Los inductores de la figura 23-82 están mutuamente acoplados. ¿Cuál es su
...
40. Para el circuito de la figura 23-83, escriba las ecuaciones de malla.
...
42. Escriba las ecuaciones de malla para el circuito de la figura 23-85. (Este es un problema desafiante.)
...
2. Mientras las cargas y voltajes de la figura 24-3(c) estén balanceados (sin tener en cuenta su valor real) las corrientes IA, IB, e IC sumaran cero. Para ilustrarlo,
...
4. Dibuje el conjunto de formas de onda de las corrientes iA, iB e iC para el circuito de la figura 24-3(c). Suponga carga puramente resistiva y balanceada.

![image](https://user-images.githubusercontent.com/84458025/132726600-ff1e4ff9-7392-42c6-82bb-cf8c4b8fcb59.png)


6. Para las cargas de la figura 24-4, Vbc = 208 V∠ - 75°.
...
8. Para la carga de la figura 24-47, Van = 347 V∠ 15°. Determine todas las corrientes de línea. Dibuje el diagrama fasorial.
...
![24-47 (2)](https://user-images.githubusercontent.com/84458025/132622820-df2ef65d-158f-401d-9fc0-d2c23867f9f1.png)
 ...
 10. Una carga Y balanceada tiene una impedancia de Zan = 14.7Ω ∠16 ° . Si Vcn = 120 V∠160° , determine todas las corrientes de línea.

![image](https://user-images.githubusercontent.com/84458025/132726992-4ce9d9d9-1f7b-44fa-9729-d109b82119d7.png)


12. Para el circuito de la figura 24-48, Vab = 480 V∠0°. Encuentre la fase y las corrientes de línea.

 
![image](https://user-images.githubusercontent.com/84458025/132727055-52a302fb-b0f1-4a7d-828a-47d59ff08190.png)


14. Para el circuito de la figura 24-48, si Iab = 10 A∠- 21°, determine todos los voltajes de línea.
 
 ![image](https://user-images.githubusercontent.com/84458025/132727101-954e6210-39c4-4588-aac1-67e29fd9ae1e.png)


16. Una carga Y balanceada tiene una impedancia de fase de 24 Ω ∠33 °y un voltaje línea a línea de 600 V. Tome Van como referencia y determine todas las corrientes de línea.

 ![image](https://user-images.githubusercontent.com/84458025/132727160-90fc6259-c1ae-46f1-b2d5-6824563a05d6.png)



26. Para la figura 24-48, suponga que las líneas tienen una impedancia Zlínea = 0.15Ω+ j0.25Ω y EAN = 120 V∠0°. Convierta la carga  en Y y use el equivalente de una fase para encontrar las corrientes de línea.
...
28. Para el circuito de la figura 24-49, suponga que Zlínea = 0.15Ω + j0.25Ω y Vab = 600 V∠30°. Determine EAB.
...
30. Los mismos datos que el problema 28 excepto que el voltaje de fase en la carga  es Va´b´ = 480 V∠30°. Encuentre el voltaje del generador EAB, magnitud y ángulo.
...
32. Para la figura 24-21(a), ZY = 15Ω + j20Ω, Z = 9 Ω- j12Ω, Zlínea = 0.1Ω + j0.1Ω, e Ia´b´ = 40 A∠73.13°. Encuentre el voltaje de fase Y Van, magnitud y ángulo.

![31 (2)](https://user-images.githubusercontent.com/84431598/132628177-c2e7ea77-3dbf-4d78-afdd-be50c5b3a781.png)

34. Repita el problema 32 para la carga balanceada de la figura 24-51, dado EAN = 120 V.
...
36. Para la figura 24-47, calcule las potencias real, reactiva y aparente con las fórmulas para PT, QT, y ST de la tabla 24-2. (Use VL = 207.8 V en lugar del valor
...
38. Para la figura 24-48, EAB = 208 V. Calcule las potencias real, reactiva y aparente con las fórmulas para PT, QT, y ST de la tabla 24-2. Compare sus resultados con los del problema 36.
...
40. Para la figura 24-53, si Vab = 600 V, determine la potencia total, la potencia reactiva total, la potencia aparente total y el factor de potencia.
...
42. Para la figura 24-19, si Vab = 480 V, determine la potencia total, la potencia reactiva total, la potencia aparente total y el factor de potencia.

![41 (2)](https://user-images.githubusercontent.com/84431598/132688707-1937026c-36a0-408d-a5b9-e75921f9374a.png)

44. Vab = 208 V para una carga balanceada Y, PT = 1200 W, y QT = 750 VAR / (ind). Seleccione Van como referencia y determine Ia. (Usa el triángulo de potencia)
...
46. Los capacitores de la figura 24-54 están conectados en Y y cada uno tiene el valor de C = 120 uF. Calcule el factor de potencia resultante. La frecuencia es de 60 Hz.
...
48. Para la figura 24-47, el voltaje de fase del generador es de 120 volts.
...
50. Para el circuito de la figura 24-56, Vab = 208 V∠30°.
...
52. Considere el circuito de la figura 24-56.
...
54. Para la figura 24-58, Rab  60 , Zbc  80 j60 . Calcule
...
56. Para la figura 24-59, calcule lo siguiente:
...
58. A partir del problema 56, I_a = 1,94 A ∠-0,737 °, I_b = 4,0 A ∠-117,7 ° e I_c = 3,57 A ∠91,4 °. Calcule lo siguiente:
